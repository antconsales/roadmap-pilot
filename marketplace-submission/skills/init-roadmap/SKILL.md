...
description: >
  ...
  Use when the user says "initialize roadmap", "create roadmap", "setup roadmap",
...
2. Report findings to the user in a concise summary:
   ...
   - Files: 147 .ts/.tsx, 23 .js (legacy)
   - Tests: Jest configured, 12 test files
   - Linting: ESLint + Prettier
   - Structure: src/ with components/, pages/, utils/, api/
   ```
...
3. Estimate: "This roadmap has N tasks, so roughly N Claude Code sessions"
4. Ask: "Want to change anything before I save it?"
...
> **Roadmap ready!** CLAUDE.md saved with N tasks in M phases.
>
> To start execution, open a new conversation and type:
> ```
> /roadmap
> ```
> Or launch autopilot:
> ```
> scripts/auto-roadmap.sh
> ```
...
```
You already have a roadmap in progress with 5/12 tasks completed.
Do you want to:
1. Continue from where you left off → use /roadmap
2. Add new tasks to the existing roadmap
3. Start fresh with a new roadmap
```
